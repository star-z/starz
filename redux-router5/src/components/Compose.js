    ...
    render() {
        ...
        return (
            <div className='compose'>
                ...
                <textarea ref='yah' name='message' value={ message } onChange={ evt => updateMessage(evt.target.value) } />
                <input type='submit' value='submit' onClick={ evt => updateMessage(evt.target.value) } />
